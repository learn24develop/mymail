...
app.controller('ToolbarController', function ToolbarController($scope, $rootScope) {
  $scope.newFolder = function() {
    console.log("new folder button is clicked");

    $rootScope.$emit('create-new-folder', 'Books' + new Date().toLocaleTimeString());
  };
});

app.controller('LeftNavController', function LeftNavController($scope, $rootScope) {
